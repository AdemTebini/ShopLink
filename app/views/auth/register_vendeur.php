...
<head>
    ...
    <title>Inscription Vendeur - ShopLink</title>
...
<body>
    ...
    <div class="auth-container" style="padding: 2rem 1rem;">
        <div class="card auth-card" style="max-width: 500px;">
            <h2 class="auth-title">Devenir Vendeur</h2>
            <div class="alert alert-info" style="font-size: 0.85rem; padding: 0.75rem;">
                ℹ️ Votre compte devra être validé par un administrateur avant de pouvoir vendre.
            </div>
            ...
            <form method="POST" action="../app/controllers/AuthController.php">
                ...
                <div class="form-group">
                    <label class="form-label">Nom de la Boutique / Vendeur</label>
